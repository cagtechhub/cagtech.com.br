...
export const siteSettingsSchema = z.object({
  ...
  siteName: z.string().default('CAG Tech'),
  seoLocality: z.string().default('Campo Grande, MS'),
  ...
  defaultOgImageUrl: z.string().default('/og-default.png'),
  ga4MeasurementId: z.string().default(''),
  metaPixelId: z.string().default(''),
  googleAdsenseAccount: z.string().default(''),
  mapsEmbedUrl: z.string().default(''),
  geoLatitude: z.string().default(''),
  geoLongitude: z.string().default(''),
...
export const updateSiteSettingsSchema = z.object({
  ...
  googleAdsenseAccount: z.string().trim().max(80).optional(),
